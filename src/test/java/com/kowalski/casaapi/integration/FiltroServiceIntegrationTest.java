...
class FiltroServiceIntegrationTest extends IntegrationTestBase {
    ...
    void buscarMeses() {
        // Act
        List<FiltroResponse> result = filtroService.buscarMeses(anoAtual);
    ...
    void buscarPessoas() {
        // Act
        List<FiltroResponse> result = filtroService.buscarPessoas(anoAtual, mesAtual);
    ...
    void buscarCartoes() {
        // Act
        List<FiltroResponse> result = filtroService.buscarCartoes(anoAtual, mesAtual, "JOAO");
    ...
    void buscarMeses_AnoInexistente() {
        // Act
        List<FiltroResponse> result = filtroService.buscarMeses("1900");
    ...
    void buscarCartoes_PessoaInexistente() {
        // Act
        List<FiltroResponse> result = filtroService.buscarCartoes(anoAtual, mesAtual, "PESSOA_INEXISTENTE");
